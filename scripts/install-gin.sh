...
# =============================================================================
# GIN INSTALLATION SCRIPT
# =============================================================================
# Standalone installer for Gin framework applications
...
DESCRIPTION:
    Creates a new Go application using the Gin web framework.
...
install_gin_app() {
    print_status "step" "Installing Gin application..."
...
EOF
    ...
    # Install Gin framework (use v1.9.x for Go 1.22 compatibility)
    print_status "info" "Installing Gin framework..."
    $CONTAINER_CMD exec --user root -w "/app/${APP_NAME}" go go get github.com/gin-gonic/gin@v1.9.1 2>&1 || true
...
EOF
    ...
    print_status "success" "Gin application installed"
}
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
            ...
            background: linear-gradient(135deg, #00758f 0%, #00add8 100%);
            min-height: 100vh;
            display: flex;
            align-items: center;
        ...
        .subtitle { color: #00758f; font-size: 1.2em; margin-bottom: 30px; }
        .info-box {
            background: #f7f7f7;
        ...
        .info-value { color: #00758f; font-family: 'Courier New', monospace; }
        ...
        .link:hover { background: #005f77; }
    </style>
</head>
<body>
    <div class="container">
        <h1>🍸 Gin</h1>
        <div class="subtitle">HTTP web framework written in Go</div>
...
main() {
    ...
    print_status "success" "Gin app '$APP_NAME' created at ${APPS_DIR}/${APP_NAME}"
    echo ""
