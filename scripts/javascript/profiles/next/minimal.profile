PROFILE_DESCRIPTION='Empty App Router project with TypeScript and no CSS framework'
SCAFFOLD=(npx --yes create-next-app@latest __APP__ --ts --eslint --no-tailwind --app --src-dir --empty --import-alias '@/*' --use-npm --disable-git)
