...
func TestDockerAdapterContractInspectLogsAndExec(t *testing.T) {
			...
			stdout: []byte(`[
  {
    ...
    "NetworkSettings": {"Ports": {"3000/tcp": [{"HostIp": "127.0.0.1", "HostPort": "8200"}]}}
		...
		"docker network inspect devarch-shop-local-net": {
			stdout: []byte(`[{"Name":"devarch-shop-local-net","Id":"network-1","Driver":"bridge"}]`),
		},
		"docker logs --timestamps --tail 10 devarch-shop-local-api": {
			stdout: []byte("2026-04-17T12:00:00Z started\n2026-04-17T12:00:01Z listening\n"),
		},
		"docker exec devarch-shop-local-api php artisan about": {
