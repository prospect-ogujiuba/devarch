# Plan index r3: cross-ecosystem-showcase-library

- Contract ID: `plan-cross-ecosystem-showcase-library-r3`
...
- Plan revision: 3
- Predecessor: `.model-artifacts/initiatives/cross-ecosystem-showcase-library/plans/2026-09-12_1637-plan-index-r2.md`
...
- Contract root: `.model-artifacts/initiatives/cross-ecosystem-showcase-library/plans/revisions/r3`
- Approval: pending exact review decision at `.model-artifacts/initiatives/cross-ecosystem-showcase-library/reports/2026-09-12_1637-plan-review-r3.md`; final decision is recorded in the mutable manifest
...
- None; r3 is eligible for exact plan review.
