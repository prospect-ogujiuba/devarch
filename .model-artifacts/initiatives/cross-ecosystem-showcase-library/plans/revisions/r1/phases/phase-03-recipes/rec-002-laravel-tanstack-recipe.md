...
Add a current TanStack Start JavaScript definition through the existing JavaScript bootstrap model; define recipe nodes/edge; configure frontend API URL and Laravel CORS/Sanctum stateful domains through reviewed adapter-owned outputs; add start/stop/verify and documentation.
...
Red definition/edge/config fixture; scaffold dry-run; injected failure/recovery; bounded real creation and HTTPS/API smoke with cleanup instructions.
